...
export default function SuccessfulCheckout() {
  ...
  useEffect(() => {    
    analyticService.Open('/financial/success-checkout', 'Successful Checkout');
  ...
  return (
    <View style={HelperStyle.fullyCentered}>
      ...
      <Image
        ...
        source={{ uri: useAsset('https://res.cloudinary.com/ds7es4cwb/image/upload/v1726526322/successful-checkout_dmjcga.png') }} />

      <Text style={IllustrationStyle.headline} id="hdSuccessCheckout">
        { i18n.t('global.restriction.successCheckout') }
      </Text>
